...
public class FavoriteMovie extends Movie {
    ...
    public FavoriteMovie(Movie movie){
        super(movie.getId(), movie.getVoteCount(), movie.getTitle(), movie.getOriginalTitle(), movie.getOverview(), movie.getPosterPath(), movie.getBigPosterPath(), movie.getBigPosterPath(),movie.getVoteAverage(), movie.getReleaseDate());
    }
}
